...
# 🌟 เพิ่มเข้ามาใหม่: Dependency สำหรับแปลง Target ID ตามสถาปัตยกรรมแบบข้ามแพลตฟอร์ม
def get_target(
    target_id: int = Path(...),
...
async def create_account(
    ...
    try:
        return await FinanceService.create_account(
            pool, req, user_ctx["discord_id"], server_id=target.server_id, room_id=target.room_id
        )
...
async def update_account(
    ...
    try:
        return await FinanceService.update_account(
            pool, account_id, req, user_ctx["discord_id"], server_id=target.server_id, room_id=target.room_id
        )
    except RoomNotFoundError as e:
        raise HTTPException(status_code=404, detail=str(e))
    except ForbiddenError as e:
...
async def delete_account(
    ...
    try:
        ...
        return await FinanceService.delete_account(
            pool, account_id, user_ctx["discord_id"], actor, server_id=target.server_id, room_id=target.room_id
        )
    except RoomNotFoundError as e:
        raise HTTPException(status_code=404, detail=str(e))
    except ForbiddenError as e:
...
async def update_collection(
    ...
    try:
        return await FinanceService.update_collection(
            pool, collection_id, req, user_ctx["discord_id"], server_id=target.server_id, room_id=target.room_id
        )
    except RoomNotFoundError as e:
        raise HTTPException(status_code=404, detail=str(e))
    except ForbiddenError as e:
...
async def add_student_to_collection(
    ...
    try:
        ...
        return await FinanceService.add_student_to_collection(
            pool, collection_id, student_id, user_ctx["discord_id"], actor, server_id=target.server_id, room_id=target.room_id
        )
    except RoomNotFoundError as e:
        raise HTTPException(status_code=404, detail=str(e))
    except ForbiddenError as e:
...
async def update_category(
    ...
    try:
        return await FinanceService.update_category(
            pool, category_id, req, user_ctx["discord_id"], server_id=target.server_id, room_id=target.room_id
        )
    except RoomNotFoundError as e:
        raise HTTPException(status_code=404, detail=str(e))
    except ForbiddenError as e:
...
async def delete_category(
    ...
    try:
        ...
        return await FinanceService.delete_category(
            pool, category_id, user_ctx["discord_id"], actor, server_id=target.server_id, room_id=target.room_id
        )
    except RoomNotFoundError as e:
        raise HTTPException(status_code=404, detail=str(e))
    except ForbiddenError as e:
...
async def revert_transaction(
    ...
    try:
        return await FinanceService.revert_transaction(
            pool, transaction_id, req.user_name, user_ctx["discord_id"], server_id=target.server_id, room_id=target.room_id
        )
