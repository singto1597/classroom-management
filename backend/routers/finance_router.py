...
# 📒 ส่งออกสมุดรายวันทั่วไป (General Journal) สำหรับนักบัญชี — อ่านจาก journal_entries
# JOIN journal_lines JOIN accounting_ledgers ตรง ๆ (ไม่ผูกกับช่วงก่อน/หลัง CUTOFF_DATE)
