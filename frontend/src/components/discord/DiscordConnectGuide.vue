...
const currentRoomCode = computed(() => {
  return props.roomCode || authStore.currentRoomCode || 'N/A';
});
...
<template>
  <Teleport to="body">
    ...
    >
      <div
        class="relative w-full max-w-lg bg-white rounded-[2.5rem] shadow-2xl border border-slate-200 overflow-hidden"
      >
        <!-- Header -->
        <div class="bg-gradient-to-r from-[#5865F2] to-[#4752C4] px-6 py-5 flex items-center gap-4">
          ...
          <!-- Close button -->
          <button
            class="ml-auto w-9 h-9 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center text-white transition-colors shrink-0"
            @click="closeModal"
          >
          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <a
                ...
                class="inline-flex items-center gap-2 px-5 py-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-bold text-sm rounded-2xl transition-all shadow-md active:scale-95"
              >
                <svg
                  class="w-5 h-5"
                  viewBox="0 0 127.14 96.36"
          ...
          <div class="flex gap-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="mt-3 flex items-center gap-2">
                ...
                <button
                  class="ml-auto px-4 py-2 bg-slate-100 hover:bg-slate-200 active:scale-95 text-slate-700 font-semibold text-xs rounded-xl transition-all flex items-center gap-1.5"
                  @click="copyRoomCode"
                >
        ...
        <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end">
          <button
            class="px-6 py-2.5 bg-slate-800 hover:bg-slate-900 text-white font-bold text-sm rounded-xl transition-all active:scale-95"
            @click="closeModal"
          >
            ปิด
          </button>
